...
use crate::{circuit::poseidon::{PermuteChip, PoseidonInstructions}, base::Hashable};
use halo2_proofs::{
...
mod tests {
    ...
    use crate::circuit::hash::MessageHashable;
